...
public class UserController {
    ...
    public ResponseEntity<String> validateUser(@RequestBody User user) {
        logger.info("Validating  the user with emailId: {}", user.getEmailId());
    ...
    private String generateToken(String emailId) {
        return Jwts.builder().setSubject(emailId).signWith(SignatureAlgorithm.HS256, "CAPSTONE-MOVIEAPP").compact();
    }
}